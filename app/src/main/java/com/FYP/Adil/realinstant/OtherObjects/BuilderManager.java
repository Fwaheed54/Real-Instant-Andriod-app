...
public class BuilderManager {
    ...
    private static int[] imageResources = new int[]{
            ...
            R.drawable.ic_format_color_text_white_48dp,
    ...
    public static void setImageResourceIndex(int imageResourceIndex) {
        BuilderManager.imageResourceIndex = imageResourceIndex;
    }
    ...
    public static SimpleCircleButton.Builder getSimpleCircleButtonBuilder(int index) {
        return new SimpleCircleButton.Builder()
                .normalImageRes(getImageResource(index));
    }
