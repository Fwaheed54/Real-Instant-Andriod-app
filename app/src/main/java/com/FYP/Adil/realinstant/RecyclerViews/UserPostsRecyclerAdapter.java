...
import com.FYP.Adil.realinstant.Models.PostDetail;
...
public class UserPostsRecyclerAdapter extends RecyclerView.Adapter<UserPostsRecyclerAdapter.GithubViewHolder> {
    ...
    public UserPostsRecyclerAdapter(Context context, AppCompatActivity activity) {
        this.context = context;
        this.activity = activity;
        Binder = new NoOfAction();
    }
    ...
    public ArrayList<PostDetail> getPostDetails() {
        return postDetails;
    }

    public void setPostDetails(ArrayList<PostDetail> postDetails) {
    ...
    public void onBindViewHolder(@NonNull final GithubViewHolder githubViewHolder, final int i) {
        ...
        //show Bill by clicking card view
        githubViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(post.getPostDetails() != null )
                    OpenBillDaialogBOx(post.getPostDetails());
                else
                    Toast.makeText(context,"Free Post",Toast.LENGTH_LONG).show();
            }
        });
        ...
        githubViewHolder.SubscriptionName.setVisibility(View.GONE);


        //Set Post Image,video or text
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.Delete_Post:
                                ...
                                new PostPresenter().DeletePost(data.get(i).getId());
                                data.remove(i);
                                break;
                        }
                        return false;
    ...
    private void ReactChecker(UserPostsRecyclerAdapter.GithubViewHolder v, int ReactId){
    ...
    private void OpenBillDaialogBOx(final PostDetail postDetail){

        LayoutInflater inflater = LayoutInflater.from(activity);
        View subView = inflater.inflate(R.layout.report_dialog_box, null);
        final TextView TotalBill =  subView.findViewById(R.id.TotalBill_Id);
        final TextView SearchBill = subView.findViewById(R.id.SearchBill_Id);
        final TextView RadiusBill = subView.findViewById(R.id.RadiusBill_Id);
        final TextView HoursBill =  subView.findViewById(R.id.HoursBill_Id);
...
//        subImageView.setImageDrawable(drawable);
        ...
        builder.setTitle("Post Bill");
        builder.setMessage("Bill Deatils");
        builder.setView(subView);
        AlertDialog alertDialog = builder.create();


        TotalBill.setText(postDetail.getTotalPrice()+"€.");
        RadiusBill.setText(postDetail.getRadiusPrice()+"€.");
        HoursBill.setText(postDetail.getNumberOfDaysPrice()+"€.");
        SearchBill.setText(postDetail.getChangeAreaPrice()+"€.");
