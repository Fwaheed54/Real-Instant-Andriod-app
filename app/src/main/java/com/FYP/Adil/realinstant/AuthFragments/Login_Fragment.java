...
public class Login_Fragment extends Fragment implements OnClickListener , AuthContract {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(Helper.getSharedPreferences("Bearer",getContext()) != null ){
			Intent HomePageIntent = new Intent(getContext(),HomeActivity.class);
			getActivity().startActivity(HomePageIntent);
			getActivity().finish();
		}else{
			initViews();
			setListeners();
	...
	private void checkValidation() {
		...
		// Else do login and do your stuff
			...
			authPresenter.Login(emailid.getText().toString(),password.getText().toString());
		}
	...
	public void getMessage(AuthMassage Massege) {
		Toast.makeText(getActivity(), Massege.getMessage(), Toast.LENGTH_SHORT).show();
	}

	@Override
	public void Login(UserLogin userLogin) {

		Helper.setSharedPreferences(userLogin.getTokenType(),userLogin.getAccessToken(),getContext());
		Intent HomePageIntent = new Intent(getContext(),HomeActivity.class);
		getActivity().startActivity(HomePageIntent);
	}
}
